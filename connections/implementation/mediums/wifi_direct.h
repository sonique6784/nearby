...
class WifiDirect {
 public:
  ...
  // Returns true, if WifiDirect communications are supported by a platform.
  ...
  // Start WifiDirect GO. Returns true if AutoGO is successfully started.
  ...
  // WifiDirect GC request to connect to the GO
  bool ConnectWifiDirect(const std::string& ssid, const std::string& password)
      ABSL_LOCKS_EXCLUDED(mutex_);
  // WifiDirect GC request to disconnect from the GO
